...
import { User, Heart, Clock, Settings, LogOut, Crown, Star, Wine, Beer, Utensils } from 'lucide-react';
...
type HistoryPairing = FavoritePairing & {
  viewed_at: string;
};
...
export default function Profile() {
  ...
  const [history, setHistory] = useState<HistoryPairing[]>([]);
    ...
    <div className="max-w-4xl mx-auto space-y-8 px-4">
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        {historyLoading ? (
          ...
          <div className="p-8 text-center text-stone-600">
            <p>Aucun accord consulté récemment</p>
            <Link to="/search" className="text-stone-800 hover:underline mt-2 inline-block">
              Découvrir les accords
            </Link>
          </div>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="text-sm text-stone-500 mt-2">
                          Consulté le {new Date(pairing.viewed_at).toLocaleDateString()} à {new Date(pairing.viewed_at).toLocaleTimeString()}
                        </p>
                      </div>
                    </div>
                  </div>
